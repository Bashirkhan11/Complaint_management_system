      ...
      <div className="container carousel-inner">
        <div className="container carousel-item active">
          <h3 className="d-flex justify-content-center" style={khan}>
            <strong style={khan1}> All Complants </strong>
          </h3>
          <p style={paragraph}>
            In this section, you can view the status of submitted
            complaints of all the users. Stay informed about any updates, resolutions, or
        ...
        <div className="container carousel-item">
          <h3 className="d-flex justify-content-center" style={khan}>
            <strong style={khan1}>Complante HandleBy Teachers</strong>
          </h3>
          <p style={paragraph}>
            In this section, you can view all those status of  submitted
            complaints on which the teachers gives there feedback. Stay informed about any updates, resolutions, or
            actions taken regarding your concerns. We believe in transparency
            and want you to feel empowered in the complaint management
        ...
        <div className="container carousel-item">
          <h3 className="d-flex justify-content-center" style={khan}>
            <strong style={khan1}>UnHandle Complante</strong>
          </h3>
          <p style={paragraph}>
            In this section, teachers did not give there  review on complaints
        ...
        <div className="container carousel-item">
          <h3 className="d-flex justify-content-center" style={khan}>
            <strong style={khan1}>Teachers&Admin Signup</strong>
          </h3>
          <p style={paragraph}>
            In this section, you create your new teachers and admins for your orginization .
            but this project for only teacher  Each complaint is categorized
            for easy access, allowing you to track its status and respond
            promptly. Use the tools provided to investigate the issue,
            communicate with the complainant, and document your actions. Our
            goal is to foster a supportive environment where concerns are
